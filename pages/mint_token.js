                        ...
                        <div className="form-create-item">
                            ...
                            <div id="create-item-1">
                                ...
                                <div className="input-group">
                                    <input className='input-text' name="name" type="text" placeholder="Item Name"
                                           required
                                           onChange={e => updateFormInput({...formInput, name: e.target.value})}/>
                                    <input name="number" type="number" placeholder="Item Price"
                                ...
                                <button name="submit"
                                        className="sc-button style letter style-2" onClick={createMarket}>Create Item
                                </button>
                            </div>
                        </div>
                    </div>
